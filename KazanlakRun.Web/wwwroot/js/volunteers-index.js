(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var filterInput = document.getElementById('volunteerFilter');
        var pageSizeInput = document.getElementById('volunteerPageSize');
        var table = document.getElementById('volunteerTable');
        var rows = Array.from(table.tBodies[0].rows);
        var firstBtn = document.getElementById('volunteerFirstBtn');
        var prevBtn = document.getElementById('volunteerPrevBtn');
        var nextBtn = document.getElementById('volunteerNextBtn');
        var lastBtn = document.getElementById('volunteerLastBtn');
        var pageInfo = document.getElementById('volunteerPageInfo');

        var defaultSize = window.volunteersDefaultPageSize || 10;
        var savedSize = getCookie('VolunteerPageSize');
        pageSizeInput.value = (savedSize && !isNaN(savedSize)) ? savedSize : defaultSize;
        ...
        function renderTable()
        {
            ...
            setCookie('VolunteerPageSize', pageSize, 365);
